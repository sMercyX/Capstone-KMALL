// src/modules/Welcome/Welcome.tsx
...
export default function Welcome() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      t2 = window.setTimeout(() => navigate("/dashboard", { replace: true }), 2800);
    })();
          ...
          <div className="flex flex-col items-center gap-3 animate-[fadeIn_.35s_ease]">
            ...
            <div className="h-16 w-16 md:h-20 md:w-20 rounded-full bg-slate-300/60 flex items-center justify-center">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                <path d="M20 6L9 17l-5-5" stroke="#111827" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            {/* ข้อความ */}
